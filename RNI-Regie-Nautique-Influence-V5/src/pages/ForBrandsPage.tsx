      ...
      <section className="brands-v4-hero">
        ...
        <div className="container brands-v4-hero__inner">
          <div>
            ...
            <p>Régie Nautique construit et coordonne des campagnes avec des créateurs spécialisés dans la voile, la plongée, le surf, les bateaux et la vie en mer.</p>
        ...
        <div className="container">
          ...
          <div className="brands-v4-value-grid">
            {[
              ...
              [Handshake,'Une seule relation agence','Régie Nautique coordonne les créateurs, le brief, les validations, les droits et le calendrier.'],
        ...
        <div className="container brands-v5-faq__grid">
          ...
          <div className="brands-v5-faq__items">
            {[
              ...
              ['Peut-on choisir directement un créateur ?', 'Oui, la sélection sert à exprimer une préférence. Régie Nautique confirme ensuite la pertinence, la disponibilité et les conditions commerciales avant toute validation.'],
              ...
              ['Qui gère les droits et les validations ?', 'Régie Nautique cadre les livrables, les dates, le processus de validation, les droits organiques ou publicitaires et l’exclusivité avec la marque et les créateurs.'],
