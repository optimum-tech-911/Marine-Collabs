      ...
      <section className="home-v4-hero">
        ...
        <div className="container home-v4-hero__inner">
          <motion.div className="home-v4-hero__copy" initial={reduced ? false : { opacity: 0, y: 20 }} animate={reduced ? undefined : { opacity: 1, y: 0 }} transition={{ duration: .7, ease: [0.22, 1, 0.36, 1] }}>
            ...
            <h1>Les voix que vos clients <em>écoutent déjà.</em></h1>
          ...
          <div className="home-v4-hero__visual" aria-label="Créateurs maritimes à la une">
            <div className="home-v4-hero__radar" aria-hidden="true"><span/><span/><span/></div>
      ...
      <section className="section home-v4-problem">
        <div className="container">
          <SectionReveal className="home-v4-problem__intro">
            <div><p className="eyebrow">LE DÉCALAGE</p><h2>Vos clients vivent déjà le nautisme en ligne.</h2></div>
            <div><p>La plupart des marques publient sans casting, sans rythme et sans lecture claire des résultats. Pendant ce temps, leurs clients suivent des créateurs qui naviguent, testent, plongent et racontent la mer chaque semaine.</p><p>Le problème n’est pas seulement le budget. C’est l’absence de méthode.</p></div>
          </SectionReveal>
          <div className="home-v4-problem__grid">
            ...
            <SectionReveal className="home-v4-problem__card home-v4-problem__card--positive" delay={.08}>
              <span className="home-v4-problem__label">Avec Régie Nautique</span>
      ...
      <section className="home-v4-manifesto">
        ...
        <div className="container home-v4-manifesto__inner">
          <SectionReveal>
            ...
            <p>Des créateurs parlent de votre marque à leur communauté. Régie Nautique sélectionne les bonnes voix, encadre les contenus et orchestre leur diffusion — sans limite de créateurs ni de frontières.</p>
      ...
      <section className="section home-v4-method">
        <div className="container">
          <SectionReveal className="section-header home-v4-section-header">
            <div><p className="eyebrow">NOTRE MÉTHODE</p><h2>Vous nous donnez un objectif. Nous orchestrons le reste.</h2></div>
            <p>Un seul interlocuteur pour le casting, les contenus, les validations, les droits, la diffusion et le bilan.</p>
          </SectionReveal>
