...
export function SolutionsPage() {
  return (
    <>
      ...
      <section className="section solutions-v4-scope"><div className="container"><SectionReveal className="solutions-v4-scope__heading"><div><p className="eyebrow eyebrow--light">DERRIÈRE LE CONTENU</p><h2>Une campagne professionnelle se joue aussi dans les détails invisibles.</h2></div><p>Régie Nautique cadre les éléments qui protègent la marque, les créateurs et la qualité d’exécution.</p></SectionReveal><div className="solutions-v4-scope__grid">{[
