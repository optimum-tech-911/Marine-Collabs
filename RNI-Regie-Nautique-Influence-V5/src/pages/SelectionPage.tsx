      ...
      <section className="section selection-v5">
        <div className="container">
          ...
          <div className="selection-v5-guidance">
            ...
            <SectionReveal delay={.04}><ShieldCheck size={22}/><div><h3>Validation agence</h3><p>Régie Nautique confirme la pertinence, la disponibilité, les droits, le calendrier et les conditions avant toute proposition.</p></div></SectionReveal>
