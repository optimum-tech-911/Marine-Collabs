...
export function CampaignBuilderPage() {
  ...
  const summary = useMemo(() => {
    ...
    return [
      'RÉGIE NAUTIQUE D’INFLUENCE — BRIEF DE CAMPAGNE','',
      ...
      'Brief généré par la version statique de la plateforme. Les métriques, disponibilités et conditions doivent être confirmées par Régie Nautique.',
    ].join('\n');
