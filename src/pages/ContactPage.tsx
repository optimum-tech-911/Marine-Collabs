...
export function ContactPage() {
  ...
  const submit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const body = [
      ...
      ...fields,
      '',
      'Demande préparée depuis la plateforme Marine Collabs.',
    ].filter(Boolean).join('\n');
