          ...
          <div className="profile-v4__main">
            ...
            <div className="profile-v4__content-grid">
              ...
              <SectionReveal className="profile-v4__panel profile-v4__campaign-fit" delay={.04}>
                ...
                <p className="profile-v4__panel-note">{commercial?.recommendationNote ?? 'Le casting, les livrables, les droits et le calendrier sont cadrés par Marine Collabs après validation du brief.'}</p>
              </SectionReveal>
            </div>
