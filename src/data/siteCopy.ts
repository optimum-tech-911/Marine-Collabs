export const siteCopy = {
  hero: {
    eyebrow: 'L’agence d’influence dédiée au nautisme',
    title: 'La meilleure pub, c’est celle qui n’en est pas une.',
    lead: 'Des créateurs parlent de votre marque. Nous orchestrons tout.',
    support: 'Aujourd’hui, une marque absente des réseaux est une marque qui n’existe pas. Nous mettons la vôtre dans la bouche de ceux que vos clients écoutent vraiment.',
  },
  booking: {
