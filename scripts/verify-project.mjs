...
for (const alias of [
  '/createurs /fr/createurs/ 302',
  '/pour-les-marques /fr/pour-les-marques/ 302',
  '/creer-une-campagne /fr/creer-une-campagne/ 302',
  '/cas-clients /fr/cas-clients/ 302',
  '/a-propos /fr/a-propos/ 302',
  '/rejoindre-le-reseau /fr/rejoindre-le-reseau/ 302',
  '/methodologie /fr/methodologie/ 302',
]) {
  if (!redirects.includes(alias)) fail(`Redirection localisée absente : ${alias}`);
}
